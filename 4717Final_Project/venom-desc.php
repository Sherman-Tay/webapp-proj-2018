            ...
            <div class=page-content>
              ...
              <div class="movie-description">
                <?php
                  ...
                  $timing1 = $dbcnx->query("SELECT * FROM seatavailability WHERE `Title` = 'Venom'");
                  $query = "SELECT * FROM `movieSeats` WHERE Title='Venom'";
                  $seatinfo = mysqli_fetch_assoc(mysqli_query($dbcnx,$query));
                  $sql ="SELECT `SeatPrice` FROM `movie` WHERE `Title`='Venom'";
