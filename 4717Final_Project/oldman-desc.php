            ...
            <div class=page-content>
              ...
              <div class="movie-description">
                <?php
                  ...
                  $pagemovie = 'The Old Man & the Gun'; //define page title
                  $sql = "SELECT * FROM `movie` WHERE `Title` = 'The Old Man & the Gun'";
                  $movies = mysqli_fetch_assoc(mysqli_query($dbcnx,$sql));
                  $timing = $dbcnx->query("SELECT * FROM seatavailability WHERE `Title` = 'The Old Man & the Gun'");
                  $timing1 = $dbcnx->query("SELECT * FROM seatavailability WHERE `Title` = 'The Old Man & the Gun'");
                  $query = "SELECT * FROM `movieSeats` WHERE Title='The Old Man & the Gun'";
                  $seatinfo = mysqli_fetch_assoc(mysqli_query($dbcnx,$query));
                  $sql ="SELECT `SeatPrice` FROM `movie` WHERE `Title`='The Old Man & the Gun'";
