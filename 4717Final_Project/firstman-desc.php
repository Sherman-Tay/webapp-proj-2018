        ...
        <div class= bottom-content>
          ...
          <div class = "content-right">
            ...
            <div class=page-content>
              <div class="movie-img">
                <img src="img/first-man-slide.jpg" >
              </div>
              <div class="movie-description">
                <?php
                  ...
                  $pagemovie = 'First Man'; //define page title
                  $sql = "SELECT * FROM `movie` WHERE `Title` = 'First Man'";
                  $movies = mysqli_fetch_assoc(mysqli_query($dbcnx,$sql));
                  $timing = $dbcnx->query("SELECT * FROM seatavailability WHERE `Title` = 'First Man'");
                  $timing1 = $dbcnx->query("SELECT * FROM seatavailability WHERE `Title` = 'First Man'");
                  $query = "SELECT * FROM `movieSeats` WHERE Title='First Man'";
                  $seatinfo = mysqli_fetch_assoc(mysqli_query($dbcnx,$query));
                  $sql ="SELECT `SeatPrice` FROM `movie` WHERE `Title`='First Man'";
