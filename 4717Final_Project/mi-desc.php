        ...
        <div class= bottom-content>
          ...
          <div class = "content-right">
            ...
            <div class=page-content>
              <div class="movie-img">
                <img src="img/mi-fallout.jpg" height = "250px" width="168px" margin-top = '30px'>
              </div>
              <div class="movie-description">
                <?php
                  ...
                  $pagemovie = 'Mission: Impossible - Fallout'; //define page title
                  $sql = "SELECT * FROM `movie` WHERE `Title` = 'Mission: Impossible - Fallout'";
                  $movies = mysqli_fetch_assoc(mysqli_query($dbcnx,$sql));
                  $timing = $dbcnx->query("SELECT * FROM seatavailability WHERE `Title` = 'Mission: Impossible - Fallout'");
                  $timing1 = $dbcnx->query("SELECT * FROM seatavailability WHERE `Title` = 'Mission: Impossible - Fallout'");
                  $query = "SELECT * FROM `movieSeats` WHERE Title='Mission: Impossible - Fallout'";
                  $seatinfo = mysqli_fetch_assoc(mysqli_query($dbcnx,$query));
                  $sql ="SELECT `SeatPrice` FROM `movie` WHERE `Title`='Mission: Impossible - Fallout'";
